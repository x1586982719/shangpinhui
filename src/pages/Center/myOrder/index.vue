    ...
    <div class="order-right">
        <div class="order-content">
            ...
            <div class="orders">
                ...
                <table class="order-item" v-for="(order, index) in orderInfo.records" :key="index">
                    <thead>
                        <tr>
                            <th colspan="5">
            ...
            <div class="block">
                ...
                <el-pagination layout="prev, pager, next" background :total="orderInfo.pages" :current-page.sync="page"
...
export default {
    ...
    methods: {
        async getMyOrder() {
            ...
            let result = await this.$API.reqMyOrder(page, this.limit)
            if (result.code = 200) {
