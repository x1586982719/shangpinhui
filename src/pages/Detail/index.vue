          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="attrlist in spuSaleAttrList" :key="attrlist.id">
                ...
                <dd changepirce="0" @click="changeCheck(attr, attrlist.spuSaleAttrValueList)"
                  :class="{ active: attr.isChecked == 1 }" v-for="attr in attrlist.spuSaleAttrValueList" :key="attr.id">
                  {{
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model="count" @input="countChange">
                <a class="plus" @click="count++">+</a>
                <a class="mins" @click="count <= 1 ? count  : count--">-</a>
              </div>
              <div class="add">
...
export default {
  ...
  methods: {
    ...
    async addCart(){
      try{
        await this.$store.dispatch('addCart', { skuid: this.$route.params.skuid, skunum: this.count })
        this.$router.push(`/addcart/${this.$route.params.skuid}/${this.count}`)
